    ...
    */
     ...
     */
        it('the menu element is hidden by default', function () {
            expect(bodyElment.className).toBe("menu-hidden");
        });
        ...
        it('the menu hide when clicked again', function () {
            expect(bodyElment.className).toBe("menu-hidden");
        });

        it('the menu display when clicked', function () {
            $('a.menu-icon-link').trigger('click');
            expect(bodyElment.className).not.toBe("menu-hidden");
        });
    });
